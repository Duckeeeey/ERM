...
class Utility(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed = discord.Embed(
            title="About Minnesota State Moderation",
            color=BLANK_COLOR,
            description="Minnesota State Moderation is a custom bot designed for moderations (Punishments), Shift Logging and LOA requests for staff. This bot was built off of ERM's framework, however has been modified.",
        )

        embed.add_field(
            name=f"Bot Information",
            value=(
                "> **ERM Git Reposotory:** [GitHub](https://github.com/mikeywhiston/ERM)\n"
                "> **ERM Community Edition (CE) Git Reposotory:** [GitHub](https://github.com/HueyMcSpewy/erm-ce)"
