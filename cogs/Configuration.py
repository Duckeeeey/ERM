            ...
            corresponding_embeds = [
                ...
                discord.Embed(
                    ...
                    description=(
                        ...
                        "All commands such as Shift Admin, LOA Admin, RA Admin, Server Manage, Config, etc., as well as nearly all configuration changes, will be logged in this channel."
                    ),
                ),
                discord.Embed(
